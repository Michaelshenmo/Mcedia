...
public class DebugEntryMMDecoderMetrics implements DebugScreenEntry {
    public static final ResourceLocation ENTRY_ID = ResourceLocation.withDefaultNamespace("zz_mm_decoder_metrics");
    private static final ResourceLocation GROUP_ID = ResourceLocation.withDefaultNamespace("zz_mm_decoder_metrics");
